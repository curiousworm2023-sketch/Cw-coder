...
export const MCU_LIST: McuChoice[] = [
    ...
    { label:'dsPIC30F3014',     description:'24KB / 30MIPS / 16-bit dsPIC, 40/44-pin, 12-bit ADC, UART x2 + SPI + I2C + 2xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F2012',     description:'12KB / 30MIPS / 16-bit dsPIC, 28-pin, UART + SPI + I2C + 2xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F2011',     description:'12KB / 30MIPS / 16-bit dsPIC, 18-pin, UART + SPI + I2C + 2xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F6014A',    description:'144KB / 30MIPS / 16-bit dsPIC, 80-pin, PORTA-G ~68 I/O, 16-ch ADC, UART x2 + SPI + I2C + 8xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F6013A',    description:'132KB / 30MIPS / 16-bit dsPIC, 80-pin, PORTA-G ~68 I/O, 16-ch ADC, UART x2 + SPI + I2C + 8xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F6011A',    description:'132KB / 30MIPS / 16-bit dsPIC, 64-pin, 16-ch ADC, UART x2 + SPI + I2C + 8xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F6012A',    description:'144KB / 30MIPS / 16-bit dsPIC, 64-pin, 16-ch ADC, UART x2 + SPI + I2C + 8xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F6010',     description:'144KB / 30MIPS / 16-bit dsPIC, 80-pin motor-control, PORTA-G, 16-ch ADC, UART x2 + SPI + I2C + 8xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F4012',     description:'48KB / 30MIPS / 16-bit dsPIC, 28-pin, 6-ch ADC, UART + SPI + I2C + 2xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F6014',     description:'144KB / 30MIPS / 16-bit dsPIC, 80-pin, PORTA-G ~68 I/O, 16-ch ADC, UART x2 + SPI + I2C + 8xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F5011',     description:'132KB / 30MIPS / 16-bit dsPIC, 64-pin, 16-ch ADC, UART x2 + SPI + I2C + 8xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F3012',     description:'24KB / 30MIPS / 16-bit dsPIC, 18-pin, 8-ch ADC, UART + SPI + I2C + 2xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F6011',     description:'132KB / 30MIPS / 16-bit dsPIC, 64-pin, 16-ch ADC, UART x2 + SPI + I2C + 8xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F6012',     description:'144KB / 30MIPS / 16-bit dsPIC, 64-pin, 16-ch ADC, UART x2 + SPI + I2C + 8xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F6013',     description:'132KB / 30MIPS / 16-bit dsPIC, 80-pin, PORTA-G ~68 I/O, 16-ch ADC, UART x2 + SPI + I2C + 8xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F5013',     description:'66KB / 30MIPS / 16-bit dsPIC, 80-pin, PORTA-G ~68 I/O, 16-ch ADC, UART x2 + SPI + I2C + 4xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F5015',     description:'66KB / 30MIPS / 16-bit dsPIC, 64-pin motor-control, PORTB-G ~52 I/O, 16-ch ADC, UART + SPI + I2C + 4xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F5016',     description:'66KB / 30MIPS / 16-bit dsPIC, 80-pin motor-control, PORTA-G ~68 I/O, 16-ch ADC, UART + SPI + I2C + 4xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F3010',     description:'24KB / 30MIPS / 16-bit dsPIC, 28-pin motor-control, 6-ch ADC, UART + SPI + I2C + 2xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F3011',     description:'24KB / 30MIPS / 16-bit dsPIC, 40/44-pin motor-control, 9-ch ADC, UART x2 + SPI + I2C + 4xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
    { label:'dsPIC30F6015',     description:'132KB / 30MIPS / 16-bit dsPIC, 64-pin motor-control, PORTB-G ~52 I/O, 16-ch ADC, UART x2 + SPI + I2C + 8xPWM, 7.3728MHz XT', family:'dsPIC', clock:'7372800' },
...
export const FRAMEWORK_LIST  = [
    { label:'picpio',     description:'PICPIO API — init()/run(), gpio_write(), uart1/i2c1/spi1 (classic Arduino-style names also work)' },
...
export function dfpFamilyFor(mcu: string): string {
    ...
    if (/DSPIC33EP/.test(u)) return ''; // XC16 v2.10 bundles dsPIC33E headers/linker scripts -- no DFP needed
...
export function halVariantFor(mcu: string): string {
    ...
    if (/DSPIC33EP/.test(u)) return 'picpio_compat_dspic33e';
...
function scaffoldProject(opts: {
    ...
    // REFERENCE.md: full pin-map/API reference is generated by `picpio reference`
    // (parsed from the selected MCU's HAL header). picpio.exe wasn't found, so
    // leave a pointer instead of duplicating that generator here.
    fs.writeFileSync(path.join(projectDir, 'REFERENCE.md'), [
        `# ${name} — PICPIO Reference`,
        '',
        `MCU: **${mcu}** (${family} family)`,
        '',
        '> picpio.exe was not found, so the full pin-map and API reference could not be',
        '> generated. Install PICPIO and run `picpio reference` in this folder to create it.',
        '',
    ].join('\n'));
    ...
    const xc16Includes = xc16Root ? [
        ...
        path.join(xc16Root, 'support', 'dsPIC33E', 'h').replace(/\\/g, '/'),
    ] : [];
