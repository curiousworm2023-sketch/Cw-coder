...
// 7.3728MHz crystal in POSCMOD=XT (no PLL) mode -> Fosc=7.3728MHz, FCY=3.6864MHz.
...
// PIC24F: FCY = Fosc / 2 (no PLL) -- unlike dsPIC30F's Fosc/4.
#define FCY (_XTAL_FREQ / 2UL)
#include <libpic30.h>

// <xc.h> (p24FJ128GA010.h) defines a typedef named "SPI" for the generic SPI
...
// ── PICPIO pin numbers -> PIC24FJ128GA010 (85 GPIO pins, PORTA-PORTG) ────────
// D0-D11  = RA0-RA7, RA9, RA10, RA14, RA15 (PORTA, 12 bits)
//   D2=RA2 (SCL2), D3=RA3 (SDA2) -- I2C2 pins, not wired to a HAL object.
// D12-D27 = RB0-RB15 (PORTB, 16 bits) -- also A0-A15 = AN0-AN15 (full 16-ch ADC)
//   D14=RB2 also doubles as SS1 (not used by the HAL's SPI master mode).
...
//   D36-D40 = RD0-RD4 = OC1-OC5 (PWM-capable, analogWrite targets;
//   LED_BUILTIN=D36/RD0/OC1). D44-D48=RD8-RD12=IC1-IC5 (plain GPIO, unused by HAL).
// D52-D61 = RE0-RE9 (PORTE, 10 bits) -- plain GPIO
// D62-D72 = RF0-RF8, RF12, RF13 (PORTF, 11 bits)
//   D64=RF2=U1RX, D65=RF3=U1TX (Serial/UART1)
//   D66=RF4=U2RX, D67=RF5=U2TX (Serial2/UART2)
//   D68=RF6=SCK1, D69=RF7=SDI1, D70=RF8=SDO1 (SPI/SPI1)
// D73-D84 = RG0-RG3, RG6-RG9, RG12-RG15 (PORTG, 12 bits)
//   D75=RG2=SCL1, D76=RG3=SDA1 (Wire/I2C1)
//   D77=RG6=SCK2, D78=RG7=SDI2, D79=RG8=SDO2, D80=RG9=SS2 (SPI2, not wired)
//
// UART1 (RF2/RF3), SPI1 (RF6-RF8) and I2C1 (RG2/RG3) are on separate pins on
// this chip, so Serial, SPI and Wire can all be used at the same time.
#define D0   0
#define D1   1
#define D2   2
#define D3   3
...
#define D66  66   // RF4 -- U2RX
#define D67  67   // RF5 -- U2TX
#define D68  68   // RF6 -- SCK1
#define D69  69   // RF7 -- SDI1
#define D70  70   // RF8 -- SDO1
#define D71  71
#define D72  72
#define D73  73
#define D74  74
#define D75  75   // RG2 -- SCL1
#define D76  76   // RG3 -- SDA1
#define D77  77
#define D78  78
#define D79  79
#define D80  80
...
// ── Native port-pin names (use these directly, e.g. gpio_write(RG2, GPIO_HIGH)) ──
...
void    analogWrite(uint8_t pin, uint8_t duty); // 8-bit PWM via OC1-OC5 (D36-D40)
...
extern TwoWire_t Wire; // I2C1 (SCL1=RG2/D75, SDA1=RG3/D76)
...
extern SPIClass_t SPI; // SPI1 (SCK1=RF6/D68, SDI1=RF7/D69, SDO1=RF8/D70)
