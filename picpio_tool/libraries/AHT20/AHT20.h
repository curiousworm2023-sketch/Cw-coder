...
// Usage:
//   aht20_t aht;
//   void init() { i2c1.begin(); aht20_begin(&aht, AHT20_ADDR); }
...
#ifndef AHT20_ADDR
#define AHT20_ADDR 0x38             // default I2C address
#endif

typedef struct { uint8_t address; } aht20_t;

uint8_t aht20_begin(aht20_t *dev, uint8_t addr);           // returns 1 if calibrated
