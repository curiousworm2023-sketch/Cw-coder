// ssd1306_font.h — classic 5x7 fixed-width font (Adafruit GFX glcdfont.c, ASCII 0-255)
// Each glyph is 5 columns x 7 rows, stored as 5 consecutive bytes (one per column,
// LSB = top pixel). Glyph for character code c starts at font5x7[(uint16_t)c * 5].
