...
// ── 40-pin classic PIC16F8xxA detection ───────────────────────────────────────
// 28-pin chips (PIC16F873A/876A) only have PORTA/B/C. The 40-pin chips
// (PIC16F874A/877A) additionally have a full PORTD and PORTE (RE0-RE2),
// exposed below as D14-D21 and D22-D24.
...
// ── PICPIO pin numbers → classic PIC16F8xxA family ──────────────────────────
#if defined(_16F628A)
...
// A0–A5  = RA0–RA5
// 28-pin chips (PIC16F873A/876A) stop here (D0-D13, A0-A5).
// 40-pin chips (PIC16F874A/877A) additionally have:
// D14–D21 = RD0–RD7
