...
#endif
#elif defined(__dsPIC30F6010__) || defined(__dsPIC30F6014__) || defined(__dsPIC30F5011__)
// Have the PRI oscillator-source bit but no PWMxL_ACT_HI/PWMxH_ACT_HI/RST_IOPIN
// motor-PWM config bits (6010 names its PWM active-level bit RST_PWMPIN; 6014 and
// 5011 have no motor PWM at all), so use the plain FBORPOR.
